...
var todos = [
  {
  todoName : "my first react",
  todoResponsibility : "Bhavya",
  todoDescription : "Learning react",
  todoPriority : "low"
},

{
  todoName : "hagubagudagu",
  todoResponsibility : "Bhavya",
  todoDescription : "fxhfxhfhfhh",
  todoPriority : "high"
},
{
  todoName : "hugabuga",
...
class App extends Component {
  ...
  render() {
    return (
      ...
      <h4 className ="list-group-item-heading">{todo.todoName}<small><span className= "badge badge-primary">{todo.todoPriority}</span></small></h4>
